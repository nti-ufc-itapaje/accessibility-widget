...
function uita_sanitize( $input ) {
    ...
    $modules = [
        'increaseText', 'increaseTextSpacing', 'increaseLineHeight',
        'invertColors', 'grayHues', 'bigCursor', 'readingGuide',
        'underlineLinks', 'textToSpeech', 'disableAnimations',
        'dyslexicFont', 'hideImages',
    ];
...
function uita_get_options() {
    $defaults = [
        ...
        'label_close'           => 'Fechar',
        'logo_url'              => '',
        'mod_increaseText'        => 1, 'mod_increaseTextSpacing' => 1,
        'mod_increaseLineHeight'  => 1, 'mod_invertColors'        => 1,
        'mod_grayHues'            => 1, 'mod_bigCursor'           => 1,
        'mod_readingGuide'        => 1, 'mod_underlineLinks'      => 1,
        'mod_textToSpeech'        => 1, 'mod_disableAnimations'   => 1,
